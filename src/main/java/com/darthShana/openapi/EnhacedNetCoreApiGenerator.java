...
public class EnhacedNetCoreApiGenerator extends AbstractCSharpCodegen {
    ...
    private static final String CSHARP_TEMPLATE_FOLDER = "csharp-netcore-enhanced";
    private static final String SERVICE_DEFAULT_URL = "serviceDefaultUrl";


    @SuppressWarnings({"hiding"})
    private static final Logger LOGGER = LoggerFactory.getLogger(EnhacedNetCoreApiGenerator.class);
    ...
    public EnhacedNetCoreApiGenerator() {
        super();
        ...
        embeddedTemplateDir = templateDir = CSHARP_TEMPLATE_FOLDER;
...
//    private void syncStringProperty(Map<String, Object> properties, String key)
    ...
    public String getName() {
        return "csharp-netcore-enhanced";
    }
